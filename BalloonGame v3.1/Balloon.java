...
public class Balloon{
    ...
    public Balloon(double x, double y){
        ...
        double prob_num = Math.random() * 100; // gives rand num from 0 to 100
        if (prob_num <= 20){ // makes 20% of the balloons 'explosive' 
            this.explode = true; 
    ...
    public double distance(double x, double y){
        return Math.hypot(x -this.centerX, y = this.centerY); 
    }
}
